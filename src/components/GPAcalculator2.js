...
return (
    ...
    <Animated.View className = 'bg-white rounded-lg shadow-sm' 
    style={[
        {
        transform: [
            {
    ...
    <Text className = 'text-center font-black mt-4 ' >Noted: Departmental modules are in Capital letters and foundational modules are in small letters</Text>
    <Text className = 'text-center font-black mt-2 ' > Use 2 credits Hours only for foundation modules and 3 credits hours for departmental modules</Text>
    <Text className = 'text-center font-black mt-2 ' >Drag down to refresh</Text>
    <ScrollView  
    refreshControl={
    ...
    >
<Picker.Item  label="Department Grades" value="" />
...
<Picker.Item  label="Foundation Grade" value="" />
<Picker.Item  label="a+" value="a+" />
<Picker.Item  label="a" value="a" />
<Picker.Item  label="a-" value="a-" />
<Picker.Item  label="b+" value="b+" />
...
<Picker.Item  label="f" value="f" />
        ...
        <View className = '' >
        <View className = 'justify-center items-center mt-12 -ml-5' >
